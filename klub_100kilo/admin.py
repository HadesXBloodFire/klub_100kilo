...
from .models import AuthGroup, AuthUser, Diet, Exercises, Gyms, Measurements, Reservations, Users


# Custom admin display for AuthGroup
@admin.register(AuthGroup)
class AuthGroupAdmin(admin.ModelAdmin):
    list_display = ("name",)


# Custom admin display for AuthUser
...
class ExercisesAdmin(admin.ModelAdmin):
    list_display = ("exercise_id", "description", "muscle_group", "difficulty", "category")
...
class ReservationsAdmin(admin.ModelAdmin):
    list_display = ("reservation_id", "user", "type", "status", "gym", "trainer_id", "date")
